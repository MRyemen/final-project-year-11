...
connected_players = 0  # Track how many players have joined
...
def threaded_client(conn, player_index):
    ...
    while True:
        try:
            ...
            if not data:
                ...
                # Add the connected_players count to the end of the data string!
    ...
    connected_players -= 1  # Subtract if they leave
    conn.close()
...
while True:
    ...
    # Force the ID to only ever be 0 or 1, even if you restart players!
